...
| [CQ-013](CQ-013-pricing-service/spec.md) | Pricing service & API | P1 | CQ-008, CQ-009 | In Progress |
...
| [CQ-021](CQ-021-report-components/spec.md) | Shared report components | P4 | CQ-005, CQ-008 | To Do |
